...
# -----------------------------------------------------------------------------
# 4. HIGH-SPEED REST DATA ENGINE (SAFE API RATE LIMITS)
# -----------------------------------------------------------------------------
...
if not st.session_state["logged_in"]:
  ...
  with tab_signals:
    ...
    if not df_klines.empty and len(df_klines) > 20:
      ...
      st.info("API feed is currently cooling down. Please wait a few seconds and refresh...")
